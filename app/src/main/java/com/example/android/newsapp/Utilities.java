...
public final class Utilities {
    ...
    /**
     * Query the Google API and return a list of {@link News} objects.
     */
 ...
 */
    private static List<News> extractNews(String newsJSON) {
        ...
        // Create an empty array list of News we can add news to
        ...
        try {
            ...
            // For each news in the newsResults, create an {@link News} object
            for (int i = 0; i < newsResults.length(); i++) {
                // Get a single news at position i within the list of news
                JSONObject currentNews = newsResults.getJSONObject(i);

                // Extract the JSONObject associated with the key called "sectionName"
                String sectionName = currentNews.getString("sectionName");

                // Extract the JSONObject associated with the key called "webTitle"
                String webTitle = currentNews.getString("webTitle");

                // Extract the JSONObject associated with the key called "webUrl"
                String webUrl = currentNews.getString("webUrl");

                // Create a new {@link News} object with section, title, and URL from the JSON response.
                News addNews = new News(webTitle, sectionName, webUrl);
